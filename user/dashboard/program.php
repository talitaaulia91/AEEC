...
<body class="js">
	...
	<header class="header shop">
		...
		<!-- Header Inner -->
		<div class="header-inner" style="background:blue">
											...
											<ul class="nav main-menu menu navbar-nav">
													...
													<li class="active"><a href="#">Our Programs<i class="ti-angle-down"></i><span class="new">New</span></a>
														<ul class="dropdown">
                                                            ...
                                                            <li><a href="checkout.html">Non regular Class</a></li>
														</ul>
													</li>
	...
	<div class="product-area most-popular section">
        <div class="container">
            <div class="row">
				<div class="col-12">
					<div class="section-title">
						<h2>Program Yang Akan Datang</h2>
					</div>
				</div>
            </div>
            <div class="row">
					...
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							...
							<p class="text">
								...
								Jl. Airlangga No. 4-6, Airlangga, Kec. Gubeng, Kota Surabaya, Jawa Timur, 60286
							</p>
							<p class="call">Got Question? Call us 24/7<span><a href="tel:123456789">0812345</a></span></p>
						</div>
						<!-- End Single Widget -->
					</div>
					...
					<div class="col-lg-2 col-md-6 col-12">
						...
						<div class="single-footer links">
							...
							<ul>
								...
								<li><a href="#">Non-Regular Program</a></li>
						...
						<div class="single-footer social">
							...
							<div class="contact">
								<ul>
									...
									<li>Open-Enrollment Program Finder</li>
									<li>Frequently Asked Questions</li>
									<li>Executive Education News</li>
								</ul>
							</div>
							<!-- End Single Widget -->
							<ul>
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © 2022 <a href="http://aeec.unair.ac.id" target="_blank">AEEC</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
