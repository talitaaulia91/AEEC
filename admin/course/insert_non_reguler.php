            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Non-Reguar Class</li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <form class="form form-vertical">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <label for="exampleInputPassword1">Tipe Class</label>
                                        <select class="form-select" name="id_tipe">
                                            <option value="">Pilih Tipe Class</option>
                                                <option value="0">
                                                <?php 
                                                echo "Executive Talk";
                                                ?>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="password-vertical">Tanggal Class</label>
                                                <input type="date" id="password-vertical" class="form-control"
                                                    name="tgl_mulai" placeholder="Tanggal Berakhir Program">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                           Deskripsi
